...
<title>Holy Wars - Cadastro: Anjo</title>
...
<div id="#Cadastrar" class="parallax-container center">
	<div class="icon-block">
		<div class="container">
			<br> <br>
			<h3 class="header center white-text-text text-lighten">Cadastrar</h3>
			...
			<a class="btn dropdown-button" href="#" data-activates="dropdown2">Anjo<i
						...
						<div class="row">
							<div class="input-field col s12">
								<input type="number" name="volume" min="0" required> <label
									class="active white-text" for="input_text">Número de
									soldados:</label>
							</div>
						</div>
						<div>
							Casta:<input class="with-gap" name="group3" type="radio"
								id="test1" checked /> <label class="active white-text"
								for="test1">Serafim</label> <input class="with-gap"
								name="group3" type="radio" id="test2" /> <label
								class="active white-text" for="test2">Querubim</label> <input
								class="with-gap" name="group3" type="radio" id="test3" /> <label
								class="active white-text" for="test3">Arcanjo</label> <br>
	...
	<div class="parallax">
		<img src="angel.jpg" alt="Unsplashed background img 1">
	</div>
</div>
</form>
</div>
