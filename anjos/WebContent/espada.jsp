...
<title>Holy Wars - Cadastro: Espada</title>
...
<div id="#Cadastrar" class="parallax-container center">
	<div class="icon-block">
		<div class="container">
			...
			<a class="btn dropdown-button" href="#" data-activates="dropdown2">Espada<i
			...
			<div class="row">
				<form class="white-text col s6 offset-s3" method="post" action="#">
					<div class="row">
						...
						<div class="row">
							<div class="input-field col s12">
								<input type="number" name="volume" min="0" required> <label
									class="active white-text" for="input_text">Ataque:</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
						...
						<div class="row">
							<div class="input-field col s12">
								<input type="number" name="volume" min="0" max="100" required>
								<label class="active white-text" for="input_text">Contra
									ataque (% do dano de ataque):</label>
							</div>
						</div>
						<div>
	...
	<div class="parallax">
		<img src="sword.jpg" alt="Unsplashed background img 1">
	</div>
</div>
</form>
</div>
